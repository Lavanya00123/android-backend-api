...
router.post("/:employeeId/attendanceReply", AttendanceController.saveAttendanceReply);
...
router.post("/sendTestNotification/:employeeId", AttendanceController.sendTestNotification);
